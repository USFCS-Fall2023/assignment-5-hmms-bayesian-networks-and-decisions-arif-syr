...
# Function to handle running queries given variables to estimate and evidence
def run(query_variable, query_evidence):
    print(alarm_infer.query(variables=query_variable, evidence=query_evidence))
